...
import man from "../assets/yp007.png";
      ...
      <Wrapper>
        ...
        >
          <div className="flex items-center gap-[6px]">
            ...
            <div>yogendrayp316@gmail.com</div>
          </div>
        ...
        >
          <div className="font-light mb-4">
            👋 Hi, I Am <span className="font-semibold">Yogendra Pawar</span>
          </div>
          <div className=" md:text-center">
            I create and maintain modern websites and applications. I solve all
            your business problems. A skilled web developer proficient in HTML,
            CSS, and JavaScript. Experienced in building responsive,
            user-friendly websites and web applications using frameworks like
            React and bootstrap. Familiar with backend technologies, version
            control, and web optimization practices.
          </div>
        </motion.div>
        {/* INTRO END */}
        ...
        {/* NUMBER BLOCK START */}
        <motion.div
          className="hidden md:flex text-center justify-center gap-8 relative z-10"
          initial={{ y: 300, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.7, delay: 0.25 }}
        >
        ...
        {/* PERSON BLOCK START */}
        <motion.div
          className="w-[300px] md:w-[260px] 2xl:w-[475px] absolute bottom-0 left-[50%] -translate-x-1/2"
          initial={{ y: 200, x: "-50%" }}
          animate={{ y: 0 }}
          transition={{ duration: 0.5 }}
        >
