        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              ...
              desc="Have good ability to create responsive layouts using media queries and fluid grids to ensure the website adapts to various screen sizes and devices."
              data={[
            ...
            <Service
              ...
              desc="Using various version control systems like Git is crucial for collaborating with other developers, tracking changes, and managing code repositories."
              data={[
                "GitHub",
                "Subversion(SVN)",
                "Bazaar",
